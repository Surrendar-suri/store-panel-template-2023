...
import FormWizard from "../../../data/ui/formWizard";
const AddMerchant = () => {
    //meta title
    document.title = "Add Merchant";
    const { Option } = Select;
    return (
        <React.Fragment>
            <div className="page-content">
                <div className="container-fluid">
                    <FormWizard merchantSlide="current" />
                    <div className="row">
                                ...
                                <div className="card-body">
                                    ...
                                    <form className="row g-3 custom-form">
                                        ...
                                        <div className="col-12 mt-4">
                                            ...
                                            <button type="submit" className="btn btn-info ms-2">Save and Continue</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
